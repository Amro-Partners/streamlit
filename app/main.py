...
def set_homepage():
    ...
    tab1, tab2, tab3, tab4 = st.tabs(cnf.tabs)
    ...
    tab3_building_param, tab3_time_param, tab3_agg_param, tab3_raw_data = cons.set_params_consumpt(col31, col32)
    ...
    return (col12, tab1_building_param, tab1_data_param, tab1_time_param, tab1_agg_param,
            ...
            col32, tab3_building_param, tab3_time_param, tab3_agg_param, tab3_raw_data,
...
def main():
    ...
    # Consumption
    cons_df = cons.consumption_summary(firestore_client, tab3_building_param, tab3_time_param, tab3_agg_param, tab3_raw_data)
    ...
    start_date = (cnf.sites_dict[tab4_building_param]['start_exp_date_utc']
                  - timedelta(days=cnf.sites_dict[tab4_building_param]['calibration_days']))
    end_date = min(date_yesterday, cnf.sites_dict[tab4_building_param]['end_exp_date_utc'])
    exp_list_of_dicts = []
    ...
    if 'exp_raw_data' in st.session_state and st.session_state.exp_raw_data:
        ...
        exp.show_summary_tables(test_dict, control_dict, col42, tab4_building_param)
        chart = exp.chart_df(metric_df, building_param, tab4_metric_param)
        col42.altair_chart(chart.interactive(), use_container_width=True)
