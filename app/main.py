...
def set_homepage():
    ...
    return (col2_rooms_hmaps, tab_rooms_hmaps_building_param, tab_rooms_hmaps_data_param, tab_rooms_hmaps_time_param, tab_rooms_hmaps_agg_param,
            ...
            col2_consumpt, tab_consumpt_building_param, tab_consumpt_time_param, tab_consumpt_agg_param, tab_consumpt_metric_param, tab_consumpt_data_param, tab_consumpt_raw_data,
...
def main():
    ...
    #                 .drop_duplicates())
    #
    # cha.run_flow_charts(charts_dict_of_dfs[tab_rooms_charts_building_param][tab_rooms_charts_floor_param][tab_rooms_charts_room_param], col2_rooms_charts)
    ...
    # # consumpt
    # cons_df = cons.consumpt_summary(firestore_client, tab_consumpt_building_param, tab_consumpt_time_param, tab_consumpt_agg_param)
    ...
    #     times.log(f'loading file expers/rooms/{date.strftime("%Y/%m/%d")}')
    #     exp_list_of_dicts.append(fb.read_and_unpickle(f'expers/rooms/{date.strftime("%Y/%m/%d")}', storage_bucket))
    #
    # exp_dict_of_dfs = {}
    # summary_dict = {}
